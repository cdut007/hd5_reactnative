/**
 * Created by Arlen_JY on 2018/6/19.
 */
...
export  default class ResultCheckView extends Component {
    ...
    rendTabs(){
        ...
        if (Global.isMonitor(Global.UserInfo) || Global.isGroup(Global.UserInfo)) {
            ...
            this.state.QuetionViewStatuArr.push('PreQCverify')  //待审核

        }else if (Global.isQC1(Global.UserInfo)) {
            this.state.QuetionViewStatuArr.push('PreQCverify') //待审核
            this.state.QuetionViewStatuArr.push('Finished')  //已完成
