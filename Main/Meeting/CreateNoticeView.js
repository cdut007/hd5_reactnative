...
export default class CreateNoticeView extends Component {
    ...
    this.setState({loadingVisible:true})
        var param = new FormData()
                ...
                param.append('startTime',Global.formatFullDateWithChina(this.state.data.startTime))
                param.append('endTime', Global.formatFullDateWithChina(this.state.data.endTime))
