...
var Map_Plan_Col = {
    ...
    'TFJH':{col1:'图纸号',col2:'管线号',col3:'房间号',col4:'工程量编号',col5:'施工日期'},
     'ZXT':{col1:'图纸号',col2:'工程量编号',col3:'房间号',col4:'工程量',col5:'施工日期'},
     'JXJH':{col1:'图纸号',col2:'设备位号',col3:'房间号',col4:'工程量',col5:'施工日期'},
     'DQJH':{col1:'图纸号',col2:'工程量编号',col3:'房间号',col4:'工程量',col5:'施工日期'},
     'YBJH':{col1:'图纸号',col2:'工程量编号',col3:'房间号',col4:'工程量',col5:'施工日期'},
     'TSJH':{col1:'图纸号',col2:'工程量编号',col3:'房间号',col4:'工程量',col5:'施工日期'},
     'BWJH':{col1:'图纸号',col2:'工程量编号',col3:'房间号',col4:'工程量',col5:'施工日期'},
}
...
var Map_Plan_Col_value = {
    ...
    'JXJH':{val1:'drawingNo',val2:'deviceNo',val3:'roomNo',val4:'projectCost',val5:'施工日期'},
    'ZXT':{val1:'drawingNo',val2:'projectNo',val3:'roomNo',val4:'projectCost',val5:'施工日期'},
    'DQJH':{val1:'drawingNo',val2:'projectNo',val3:'roomNo',val4:'projectCost',val5:'施工日期'},
    'YBJH':{val1:'drawingNo',val2:'projectNo',val3:'roomNo',val4:'projectCost',val5:'施工日期'},
    'TSJH':{val1:'drawingNo',val2:'projectNo',val3:'roomNo',val4:'projectCost',val5:'施工日期'},
    'BWJH':{val1:'drawingNo',val2:'projectNo',val3:'roomNo',val4:'projectCost',val5:'施工日期'},
...
var Map_Witness_Col = {
    'GDJH':{col1:'发起日期',col2:'工序编号/名称',col3:'见证点类型',col4:'焊口/支架',},
    'TFJH':{col1:'发起日期',col2:'工序编号/名称',col3:'见证点类型',col4:'管线号',},
    'JXJH':{col1:'发起日期',col2:'工序编号/名称',col3:'见证点类型',col4:'设备位号',},
    'ZXT':{col1:'发起日期',col2:'工序编号/名称',col3:'见证点类型',col4:'焊口/支架',},
    'DQJH':{col1:'发起日期',col2:'工序编号/名称',col3:'见证点类型',col4:'焊口/支架',},
    'YBJH':{col1:'发起日期',col2:'工序编号/名称',col3:'见证点类型',col4:'焊口/支架',},
    'TSJH':{col1:'发起日期',col2:'工序编号/名称',col3:'见证点类型',col4:'焊口/支架',},
    'BWJH':{col1:'发起日期',col2:'工序编号/名称',col3:'见证点类型',col4:'焊口/支架',},
}
...
var Map_QC_Witness_Col = {
    'GDJH':{col1:'图纸号',col2:'见证地点',col3:'见证时间',col4:'工序编号/名称',col5:'发起人'},
    'TFJH':{col1:'图纸号',col2:'见证地点',col3:'见证时间',col4:'工序编号/名称',col5:'发起人'},
    'JXJH':{col1:'图纸号',col2:'见证地点',col3:'见证时间',col4:'工序编号/名称',col5:'发起人'},
    'ZXT':{col1:'图纸号',col2:'见证地点',col3:'见证时间',col4:'工序编号/名称',col5:'发起人'},
    'DQJH':{col1:'图纸号',col2:'见证地点',col3:'见证时间',col4:'工序编号/名称',col5:'发起人'},
    'YBJH':{col1:'图纸号',col2:'见证地点',col3:'见证时间',col4:'工序编号/名称',col5:'发起人'},
    'TSJH':{col1:'图纸号',col2:'见证地点',col3:'见证时间',col4:'工序编号/名称',col5:'发起人'},
    'BWJH':{col1:'图纸号',col2:'见证地点',col3:'见证时间',col4:'工序编号/名称',col5:'发起人'},
}
...
module.exports = {
    ...
    getdisplyInfo(displayAry,data,type ){
         ...
         if(type == 'JXJH'){
             displayAry.push({title:'设备位号',content:data.projectNo,id:'1',noLine:true});
        ...
        displayAry.push({title:'质量计划号',content:data.qualityplanno,id:'x3'})
         ...
         displayAry.push({title:'ITP名称',content:data.itpName,id:'x10'},);
            ...
            if (type == 'GDJH') {
                ...
                displayAry.push({title:'工程量名称',content:data.projectType,id:'x8'});

                displayAry.push({title:'设备名称',content:data.deviceName,id:'r0'});

                //displayAry.push({title:'设备位号',content:data.deviceNo,id:'r1'});
